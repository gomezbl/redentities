...
class SelectQueryBuilder {
    ...
    async Run() {
        let sql = this.Formatters.FormatSelect(this.selectProperties);
    ...
    async IterateAll( fnc ) {
        let fields = this.selectProperties.fields;
        ...
        for( let i = 0; i < count; i+= PAGESIZE ) {
            ...
            let entities = await this.sqlEntities.RunQuery( this.Formatters.FormatSelect(this.selectProperties) );
    ...
    async SingleById( entityId ) {
        ...
        let entity = await this.sqlEntities.RunQuery( this.Formatters.FormatSelect(this.selectProperties) ) 
    ...
    async Count() {
        ...
        let result = await this.sqlEntities.RunQuery( this.Formatters.FormatSelect(this.selectProperties) );
