...
class SqlEntities {
    constructor(databaseConfig, databaseSchema, connector, formatters) {
    ...
    async RemoveDatabase( databaseName ) {
        let sql = this.Formatters.FormatDropDatabase( databaseName );

        // Note: remove a new database should be done with new connection
        await this.Connector.RunQueryOwnConnection( this.DatabaseConfig, sql );
    }

    async CreateDatabase( databaseName ) {
        let sql = this.Formatters.FormatCreateDatabase( databaseName );

        // Note: create a new database should be done with new connection
        await this.Connector.RunQueryOwnConnection( this.DatabaseConfig, sql );
    }
